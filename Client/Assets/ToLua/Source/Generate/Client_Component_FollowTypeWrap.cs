...
public class Client_Component_FollowTypeWrap
{
	...
	static Type TypeOf_Client_Component_FollowType = typeof(Client.Component.FollowType);

	static bool CheckType(IntPtr L, int pos)
	{
		return TypeChecker.CheckEnumType(TypeOf_Client_Component_FollowType, L, pos);
	}
