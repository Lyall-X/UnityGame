...
public class Client_Define_EventNamesWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Client.Define.EventNames), typeof(System.Object));
		L.RegFunction("New", new LuaCSFunction(_CreateClient_Define_EventNames));
	...
	static int _CreateClient_Define_EventNames(IntPtr L)
	{
		try
		{
