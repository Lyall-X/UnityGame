...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule("Data");
		Client_Data_LevelTypeWrap.Register(L);
		Client_Data_MapDataWrap.Register(L);
		Client_Data_ChapterDataWrap.Register(L);
		Client_Data_DungeonDataWrap.Register(L);
		Client_Data_DialogDataWrap.Register(L);
		L.EndModule();
		L.BeginModule("Define");
		Client_Define_ResultCodeWrap.Register(L);
		Client_Define_EventNamesWrap.Register(L);
		L.EndModule();
		L.BeginModule("Component");
		Client_Component_FollowTypeWrap.Register(L);
		Client_Component_VarTypeWrap.Register(L);
		Client_Component_CTimerWrap.Register(L);
		Client_Component_CLuaAnimatorWrap.Register(L);
		Client_Component_CMultiProgressBarWrap.Register(L);
		Client_Component_CObjectFollowWrap.Register(L);
		Client_Component_CLuaComponentWrap.Register(L);
		Client_Component_CPrefabVarWrap.Register(L);
		Client_Component_VarDataWrap.Register(L);
		L.EndModule();
		L.BeginModule("Utility");
		Client_Utility_UtilWrap.Register(L);
		Client_Utility_LuaHelperWrap.Register(L);
		L.EndModule();
		L.BeginModule("Behaviour");
		Client_Behaviour_LuaBehaviourWrap.Register(L);
		L.EndModule();
		L.BeginModule("View");
		Client_View_RoleViewWrap.Register(L);
		Client_View_NPCViewWrap.Register(L);
		L.EndModule();
		L.BeginModule("Manager");
		Client_Manager_GameManagerWrap.Register(L);
		Client_Manager_SoundManagerWrap.Register(L);
		Client_Manager_NPCManagerWrap.Register(L);
		Client_Manager_ResourceManagerWrap.Register(L);
		Client_Manager_ShaderManagerWrap.Register(L);
		Client_Manager_NetworkManagerWrap.Register(L);
